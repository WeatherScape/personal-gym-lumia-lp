...
export function Footer() {
  return (
    <footer className="border-t border-border bg-[#fffdfb] pb-28 pt-10 sm:pb-10">
      <div className="container grid gap-8 sm:grid-cols-[1.2fr_0.8fr]">
        <div>
          <p className="font-serif text-xl font-semibold text-[#5b4245]">
            {siteConfig.name}
          </p>
          <p className="mt-3 max-w-md text-sm leading-7 text-muted-foreground">
            {siteConfig.concept}。眉・まつげ・フェイシャルのご予約、メニュー相談はLINEからお気軽にどうぞ。
          </p>
        </div>
